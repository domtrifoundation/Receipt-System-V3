...
class InferenceServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.Generate = channel.unary_unary(
                '/resibo.inference.v1.InferenceService/Generate',
...
def add_InferenceServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'resibo.inference.v1.InferenceService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('resibo.inference.v1.InferenceService', rpc_method_handlers)
